  ...
  <div class="flex-1" v-loading="loading">
    <div class="export-parent">
      ...
      <template v-if="!type && !message">
        <div class="flex-row export-div" v-show="downloadUrl">
          <span class="export-col-left">
            <img class="iconImport" src="./assets/download.png" />
          </span>
        ...
        <div class="export-div flex-row" style="margin-top: 30px">
          <span class="export-col-left">
            <img class="iconImport" src="./assets/upload.png" />
          </span>
          <div class="flex-1 export-col-right flex-row">
            <div class="export-right-cont flex-1">
              <p class="explain_box">上传填好的{{ name }}表</p>
              <p class="explain_box">
              ...
              >
                <div
                  ...
                  :key="i"
                >
                  <div class="file-name flex-1 el" :title="item.name">
                    {{ item.name }}
                  </div>
                </div>
              </div>
            ...
            <div class="export-right-btn">
              <uploader
                ...
                :autoUpload="false"
              >
                <el-button slot="button" type="primary" plain
                  >上传文件</el-button
                >
              </uploader>
            </div>
      ...
      <template v-else>
        ...
        <div v-if="type == 'error'">
          ...
          <p class="typeMes" @click="errorDocument">文档.xlsx</p>
        </div>
        <div class="export-btn">
          <el-button type="primary" @click="again">重新上传</el-button>
          <el-button type="primary" plain @click="cancelFunc">取消</el-button>
        </div>
      </template>
    </div>
  </div>
