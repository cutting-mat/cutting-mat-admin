<template>
  <div class="example">
    ...
    <div class="demo">
      ...
      <el-input type="textarea" :rows="6" :value="'富文本数据：' + JSON.stringify(content)" />
    </div>
    <pre class="code">
        <textarea readonly>
        <richtext v-model="content" />
    ...
    <p>配合JSON存取接口可实现异步模式，此时v-model传递的值为JSON数据的存储ID[String]：</p>

    <div class="demo">
      <richtext v-model="contentUrl" async />
